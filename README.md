...
As originally generated, it will produce a new library project when run:
    ...
    $ clojure -Sdeps '{:deps {sandmark/reloadable {:git/url "https://github.com/sandmark/reloadable" :git/sha ""}}}' -Tnew create :template sandmark/reloadable :name myusername/mycoollib
