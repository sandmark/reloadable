...
As originally generated, it will produce a new library project when run:
    ...
    $ clojure -Sdeps '{:deps {sandmark/reloadable {:git/url "https://github.com/sandmark/reloadable" :git/sha "a892946705c9514061a1eb7036de7b9fc0b83b00"}}}' -Tnew create :template sandmark/reloadable :name myusername/mycoollib
